...
// Test page: same climbing content as the live page, plus an interactive
// expedition map (Leaflet, loaded from CDN). Each peak places a marker —
// hover for the summit, click for the full record.
const expeditions = [
  {
    name: 'Mount Everest',
...
export default function ClimbingTest() {
  ...
  useEffect(() => {
    ...
    loadLeaflet()
      .then((L) => {
        ...
        const markers = expeditions.map((peak) => {
  ...
  return (
    <main className="page-main" id="climbing-test">
